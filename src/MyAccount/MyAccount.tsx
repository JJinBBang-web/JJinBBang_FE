...
import LeaveServiceModal1 from './components/LeaveServiceModal1';
import LeaveServiceModal2 from './components/LeaveServiceModal2';
    ...
    <div className="content">
      ...
      <div className={styles.container}>
        ...
        <button
          ...
          onClick={auth.verificationStatus !== 'verified' ? () => navigate('/auth/verify') : undefined}
