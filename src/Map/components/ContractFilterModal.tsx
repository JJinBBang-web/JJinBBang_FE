...
import { monthlyRentRangeState, depositRangeState, selectedTypeState, selectedContractState, filterState, maintenanceCostState } from "../recoil/mapRecoilState";
...
const ContractFilterModal = () => {
    ...
    const handleConfirm = () => {
        if (isConfirmActive) {
            ...
            setTimeout(() => {
                setBottomSheet({ isOpenModal: false, type: 'contract' });
            }, 200);
        }
    };
