  ...
  default: [
    {
      ...
      positiveFilters: [
        ...
        { label: '동네가 안전해요', icon: PO_LO_07, key: "PO_LO_07" },
        { label: '이웃들이 친절해요', icon: PO_LO_08, key: "PO_LO_08" },
      ],
      negativeFilters: [
        { label: '교통이 불편해요', icon: NE_LO_01 , key: "NE_LO_01"},
        { label: '환경이 지저분해요', icon: NE_LO_02 , key: "NE_LO_02"},
        { label: '동네가 시끄러워요', icon: NE_LO_03 , key: "NE_LO_03"},
        ...
        { label: '이웃들이 불친절해요', icon: NE_LO_08 , key: "NE_LO_08"},
      ],
    ...
    },
    {
      ...
      positiveFilters: [
        ...
        { label: '관리비가 합리적이에요', icon: PO_MT_04, key: "PO_MT_04"},
        { label: '인터넷이 잘 돼요', icon: PO_MT_05, key: "PO_MT_05"},
        { label: '관리가 정기적이에요', icon: PO_MT_06, key: "PO_MT_06"},
        { label: '이사가 편했어요', icon: PO_MT_07, key: "PO_MT_07"},
      ],
      negativeFilters: [
        ...
        { label: '관리비가 비싸요', icon: NE_MT_04, key: "NE_MT_04"},
        { label: '인터넷이 느려요', icon: NE_MT_05, key: "NE_MT_05"},
        { label: '관리가 부족해요', icon: NE_MT_06, key: "NE_MT_06"},
        { label: '이사가 힘들었어요', icon: NE_MT_07, key: "NE_MT_07"},
      ],
    },
  ],
});
