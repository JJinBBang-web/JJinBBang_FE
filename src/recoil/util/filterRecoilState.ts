  ...
  default: [
    ...
    },
    {
      ...
      positiveFilters: [
        ...
        { label: '냉난방이 잘 돼요', icon: PO_ST_06 },
        { label: '배수와 수압이 좋아요', icon: PO_ST_07 },
        { label: '곰팡이가 없어요', icon: PO_ST_05 },
      ],
      negativeFilters: [
        ...
        { label: '냉난방이 안돼요', icon: NE_ST_06 },
        { label: '배수와 수압이 약해요', icon: NE_ST_07 },
        { label: '곰팡이가 많아요', icon: NE_ST_05 },
      ],
    },
    {
      category: '편의시설과 관리',
      ...
      negativeFilters: [
        ...
        { label: '관리가 부족해요', icon: NE_MT_06 },
        { label: '이사가 힘들었어요', icon: NE_MT_07 },
        { label: '인터넷이 느려요', icon: NE_MT_05 },
        { label: '엘리베이터가 없어요', icon: NE_MT_02 },
        { label: '관리비가 비싸요', icon: NE_MT_04 },
        { label: '쓰레기 처리가 불편해요', icon: NE_MT_03 },
      ],
    },
  ],
});
