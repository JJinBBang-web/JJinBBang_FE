...
// ✅ 기숙사 리뷰 필터 상태 (변경 없는 아이콘은 원본 파일 그대로 사용, 신규 항목만 D_ 파일 사용)
...
// 신규 아이콘
import D_PO_MT_08 from '../../assets/image/D_PO_MT_08.svg'; // 공용시설이 쾌적해요
import D_PO_MT_09 from '../../assets/image/D_PO_MT_09.svg'; // 통금이 없어요
import D_PO_MT_10 from '../../assets/image/D_PO_MT_10.svg'; // 휴게시설이 충분해요
import D_PO_MT_11 from '../../assets/image/D_PO_MT_11.svg'; // 규칙이 유연해요
...
// 신규 아이콘
import D_NE_MT_10 from '../../assets/image/D_NE_MT_10.svg'; // 공용시설이 불편해요
import D_NE_MT_11 from '../../assets/image/D_NE_MT_11.svg'; // 통금이 있어요
import D_NE_MT_12 from '../../assets/image/D_NE_MT_12.svg'; // 휴게시설이 불충분해요
import D_NE_MT_13 from '../../assets/image/D_NE_MT_13.svg'; // 규칙이 엄격해요
  ...
  default: [
    {
      ...
      positiveFilters: [
        ...
        { label: '주변이 조용해요', icon: PO_LO_03, key: 'PO_LO_03' },
    ...
    },
    {
      ...
      negativeFilters: [
        ...
        { label: '건물이 낡았어요', icon: NE_ST_04, key: 'NE_ST_04' },
    ...
    },
    {
      ...
      positiveFilters: [
        ...
        { label: '공용시설이 쾌적해요', icon: D_PO_MT_08, key: 'PO_MT_08' },
        { label: '통금이 없어요', icon: D_PO_MT_09, key: 'PO_MT_09' },
        { label: '휴게시설이 충분해요', icon: D_PO_MT_10, key: 'PO_MT_10' },
        { label: '규칙이 유연해요', icon: D_PO_MT_11, key: 'PO_MT_11' },
      ],
      negativeFilters: [
        ...
        { label: '입주가 힘들었어요', icon: NE_MT_07, key: 'NE_MT_07' },
        { label: '공용시설이 불편해요', icon: D_NE_MT_10, key: 'NE_MT_10' },
        { label: '통금이 있어요', icon: D_NE_MT_11, key: 'NE_MT_11' },
        { label: '휴게시설이 불충분해요', icon: D_NE_MT_12, key: 'NE_MT_12' },
        { label: '규칙이 엄격해요', icon: D_NE_MT_13, key: 'NE_MT_13' },
      ],
    },
  ],
});
